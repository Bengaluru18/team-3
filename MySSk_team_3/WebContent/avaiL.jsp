...
<table>
	...
	<tr>
		<th>Slot 1</th>
		<td><select name='date_slot'>
			<option value='11'><%=days.get(0) %> </option>
			<option>  Schedule </option>
		</select></td>
		<td><select>
			<option value='21'> <%= days.get(3)%></option>
			<option>  Schedule </option>
		</select></td>
		<td><select>
			<option value='31'> <%=days.get(6) %></option>
			<option>  Schedule </option>
		</select></td>
		<td><select>
			<option value='41'><%=days.get(9) %> </option>
			<option>  Schedule </option>
		</select></td>
		<td><select>
			<option value='51'><%=days.get(12) %> </option>
			<option>  Schedule </option>
		</select></td>
	</tr>
	...
	<tr>
		<th>Slot 2</th>
		<td><select>
			<option value='12'><%=days.get(1) %> </option>
			<option>  Schedule </option>
		</select></td>
		<td><select>
			<option value='22'><%=days.get(4) %> </option>
			<option>  Schedule </option>
		</select></td>
		<td><select>
			<option value='32'> <%=days.get(7) %></option>
			<option>  Schedule </option>
		</select></td>
		<td><select>
			<option value='42'> <%=days.get(10) %></option>
			<option>  Schedule </option>
		</select></td>
		<td><select>
			<option value='52'><%=days.get(13) %> </option>
			<option>  Schedule </option>
		</select></td>
	</tr>
	...
	<tr>
		<th>Slot 3</th>
		<td><select>
			<option value='13'><%=days.get(2) %> </option>
			<option>  Schedule </option>
		</select></td>
		<td><select>
			<option value='23'> <%=days.get(5) %></option>
			<option>  Schedule </option>
		</select></td>
		<td><select>
			<option value='33'><%=days.get(8) %> </option>
			<option>  Schedule </option>
		</select></td>
		<td><select>
			<option value='43'> <%=days.get(11) %></option>
			<option>  Schedule </option>
		</select></td>
		<td><select>
			<option value='53'><%=days.get(14) %> </option>
			<option>  Schedule </option>
		</select></td>
	</tr>
